...
- **Start the summary with a gerund** (verb ending in -ing): e.g., "Adding", "Fixing", "Simplifying", "Removing"
...
- `LPD-83847 Processing content per item instead of loading entire JSON into memory`
- `LPD-83357 Adding validation to prevent folder changes for CMS object definitions`
- `LPD-83630 Fixing typo`
- `LCD-50509 Granting ArgoCD permission to correct namespace`
